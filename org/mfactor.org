...
In order to incorporate this into a project, several rake tasks are supplied in [[file:../tasks/stdlib.rake][tasks/stdlib.rake]]

- *stdlib*: the main task, which, when called, generates above code
