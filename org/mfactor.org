...
There is built-in support for work lookup in the dictionary (TODO: link to section that
explains dictionary format), mainly for speed and debugging reasons.
